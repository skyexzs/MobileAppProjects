...
public class UserDatabase extends SQLiteOpenHelper {
    ...
    public int deleteUser(String email) {
        ...
        int delRowId = db.delete(Util.UserKey.TABLE_NAME_USERS, Util.UserKey.EMAIL + "=?", new String[] {email});
        db.close();
        return delRowId;
    }
    ...
    public int updateToken(String email, String token) {
        ...
        int updRowId = db.update(Util.UserKey.TABLE_NAME_USERS, contentValues,
