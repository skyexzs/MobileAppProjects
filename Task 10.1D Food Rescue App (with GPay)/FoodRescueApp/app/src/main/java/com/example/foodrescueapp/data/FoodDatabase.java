...
public class FoodDatabase extends SQLiteOpenHelper {
    ...
    public int deleteFoodData(int id) {
        ...
        int delRowCount = db.delete(Util.FoodKey.TABLE_NAME_FOODS, Util.FoodKey.FOOD_ID + "=?", new String[] {String.valueOf(id)});
        db.close();
        return delRowCount;
    }
    ...
    public int setShared(int id, boolean b) {
        ...
        int updRowCount = db.update(Util.FoodKey.TABLE_NAME_FOODS, contentValues, Util.FoodKey.FOOD_ID + "=?", new String[] {String.valueOf(id)});
        db.close();
        return updRowCount;
    }

    public FoodData fetchFoodData(int id) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(Util.FoodKey.TABLE_NAME_FOODS, null, Util.FoodKey.FOOD_ID + "=?",
        ...
        try {
            ...
            FoodData foodData = new FoodData(food_id, image_path, title, desc, date, quantity, location, shared, owner_email);
